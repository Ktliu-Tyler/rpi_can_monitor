...
@app.get("/imu2", response_class=HTMLResponse)
async def imu2_dashboard(request: Request):
...
async def get_data():
    if can_receiver:
        return {
            ...
            'imu': can_receiver.decoder.data_store['imu'],
            'imu2': can_receiver.decoder.data_store['imu2'],
